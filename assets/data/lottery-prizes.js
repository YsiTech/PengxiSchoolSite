...
window.LOTTERY_CONFIG = {
  ...
  prizes: [
    { id: 'p20', name: '20 亚斯卢布', type: 'money', reward: 20, weight: 20 },
    { id: 'none', name: '再接再厉', type: 'none', reward: 0, weight: 10 },
    { id: 'p50', name: '50 亚斯卢布', type: 'money', reward: 50, weight: 45 },
    ...
    { id: 'gift', name: '精美小礼品', type: 'gift', reward: 0, weight: 5 },
